...
#include "internal.h"
#include "../terminal/terminal/v568/driver/basefunc/v578regdef.h"
...
static const TRegUnit gSifReg[] =
{
	...
	{ V568_REGTYPE, "V5_REG_SIF_HD_STARTH",				V5_REG_SIF_HD_STARTH,			0, 0, "adjust the width of hd output to sensor" },
	{ V568_REGTYPE, "V5_REG_SIF_HD_STARTL",				V5_REG_SIF_HD_STARTL,			0, 0 },
	{ V568_REGTYPE, "V5_REG_SIF_HD_STOPH",				V5_REG_SIF_HD_STOPH,			0, 0, "adjust the width of hd output to sensor" },
	{ V568_REGTYPE, "V5_REG_SIF_HD_STOPL",				V5_REG_SIF_HD_STOPL,			0, 0 },
	{ V568_REGTYPE, "V5_REG_SIF_HSYNC_STARTH",			V5_REG_SIF_HSYNC_STARTH,		0, 0, "adjust the width of hsync output to sensor" },
	{ V568_REGTYPE, "V5_REG_SIF_HSYNC_STARTL",			V5_REG_SIF_HSYNC_STARTL,		0, 0 },
	{ V568_REGTYPE, "V5_REG_SIF_HSYNC_STOPH",			V5_REG_SIF_HSYNC_STOPH,			0, 0, "adjust the width of hsync output to sensor" },
	{ V568_REGTYPE, "V5_REG_SIF_HSYNC_STOPL",			V5_REG_SIF_HSYNC_STOPL,			0, 0 },
	...
	{ V568_REGTYPE, "V5_REG_SIF_UMCTRL_SEL",			V5_REG_SIF_UMCTRL_SEL,			0, 0, "[3:0]: Select sif_um output." },
	{ V568_REGTYPE, "V5_REG_SIF_FIFO_STATUS",			V5_REG_SIF_FIFO_STATUS,			0, 0, "[7]: sif_fifo_full : this bit set by sif_fifo module, clear by host." },
	{ V568_REGTYPE, "V5_REG_SIF_VSYNC_DELAY",			V5_REG_SIF_VSYNC_DELAY_H,		0, 0 },
	{ V568_REGTYPE, "V5_REG_SIF_VSYNC_DELAY_H",			V5_REG_SIF_VSYNC_DELAY,			0, 0 }
};
...
static const TRegUnit gCtrlReg[] =
{
	...
	{ V568_REGTYPE, "V5_REG_CPM_INTFLAG7", V5_REG_CPM_INTFLAG7, 0, 0, "The second level interrupt status flag\n" },
	...
	{ V568_REGTYPE, "V5_REG_CPM_INTEN5", V5_REG_CPM_INTEN5, 0, 0, "marb main 2nd level interrupt enable" },
	{ V568_REGTYPE, "V5_REG_CPM_INTEN6", V5_REG_CPM_INTEN6, 0, 0, "lcdc 2nd level interrupt enable" },
	{ V568_REGTYPE, "V5_REG_CPM_INTEN7", V5_REG_CPM_INTEN7, 0, 0, "mrab slave 2nd level interrupt enable" },
...
{
	{ V568_REGTYPE, "V5_REG_ISP_CTL_BAS",			V5_REG_ISP_CTL_BAS,				0, 0, "[7]: hi_pass (0: Sharp Is Low Pass Filter; 1: Sharp Is High Pass Filter).\n[6]: yuv_sif_en (0: Bayer Pattern Format; 1: YUV Format).\n[5]: (0: RG Line First; 1: BG Line First).\n[4]: G Pixel First.\n[3:0]: Image Pixel Rate" },
	{ V568_REGTYPE, "V5_REG_ISP_CTL_BAS_H",			V5_REG_ISP_CTL_BAS_H,			0, 0, "[7]: Y Only (0: Color Image; 1: Gray Image).\n[6]: Digital Gain Enable.\n[5]: Y Gamma Correction Enable.\n[4]: Color Correction Enable.\n[3]: RGB Gamma Correction Enable.\n[2]: DPD/DPC & Noise Remove Enable.\n[1]: Lens Fall Off Enable.\n[0]: Sharp Edge Enable." },
	...
	{ V568_REGTYPE, "V5_REG_ISP_WIN_H",				V5_REG_ISP_WIN_H,				0, 0, "Video Window Height In Test Bar Mode. Max 480." },
	{ V568_REGTYPE, "V5_REG_ISP_WIN_H_H",			V5_REG_ISP_WIN_H_H,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_IMG_W",				V5_REG_ISP_IMG_W,				0, 0, "[11:0]: Actual Image Width Value." },
	{ V568_REGTYPE, "V5_REG_ISP_IMG_W_H",			V5_REG_ISP_IMG_W_H,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_IMG_H",				V5_REG_ISP_IMG_H,				0, 0, "[11:0]: Actual Image Height Value." },
	{ V568_REGTYPE, "V5_REG_ISP_IMG_H_H",			V5_REG_ISP_IMG_H_H,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_FEM_M",				V5_REG_ISP_FEM_M,				0, 0, "[7:0]: Parameters of EMLUT() (16 * m)." },
	{ V568_REGTYPE, "V5_REG_ISP_FEM_P",				V5_REG_ISP_FEM_P,				0, 0, "[7:0]: Parameters of EMLUT() (16 * m * x2 / (x2 - x1))." },
	{ V568_REGTYPE, "V5_REG_ISP_FEM_X1",			V5_REG_ISP_FEM_X1,				0, 0, "[7:0]: Parameters of EMLUT() (x1)." },
	{ V568_REGTYPE, "V5_REG_ISP_FEM_X2",			V5_REG_ISP_FEM_X2,				0, 0, "[7:0]: Parameters of EMLUT() (x2)." },
	{ V568_REGTYPE, "V5_REG_ISP_FEM_MIN",			V5_REG_ISP_FEM_MIN,				0, 0, "Min of EMLUT()" },
	{ V568_REGTYPE, "V5_REG_ISP_FEM_MAX",			V5_REG_ISP_FEM_MAX,				0, 0, "Max of EMLUT()" },
	{ V568_REGTYPE, "V5_REG_ISP_CENTER_X",			V5_REG_ISP_CENTER_X,			0, 0, "Coordinate x of sensor lens focus." },
	{ V568_REGTYPE, "V5_REG_ISP_CENTER_X_H",		V5_REG_ISP_CENTER_X_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_CENTER_Y",			V5_REG_ISP_CENTER_Y,			0, 0, "Coordinate y of sensor lens focus." },
	{ V568_REGTYPE, "V5_REG_ISP_CENTER_Y_H",		V5_REG_ISP_CENTER_Y_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_F2_RECPROC",		V5_REG_ISP_F2_RECPROC,			0, 0, "2^24 * (1 / F^2) , F is focus length of sensor." },
	{ V568_REGTYPE, "V5_REG_ISP_F2_RECPROC_H",		V5_REG_ISP_F2_RECPROC_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AFLNCTL",			V5_REG_ISP_AFLNCTL,				0, 0, "[15]: AF Line Mode.\n[14:9]: AF Line Counter.\n[8:0]: AF Line Start (Actual start position is bit[8:0] * 8)." },
	{ V568_REGTYPE, "V5_REG_ISP_AFLNCTL_H",			V5_REG_ISP_AFLNCTL_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AFSTA",				V5_REG_ISP_AFSTA,				0, 0, "[25:0]: AF statistics feedback value." },
	{ V568_REGTYPE, "V5_REG_ISP_AFSTA_1",			V5_REG_ISP_AFSTA_1,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AFSTA_2",			V5_REG_ISP_AFSTA_2,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AFSTA_3",			V5_REG_ISP_AFSTA_3,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AFLNSTEP",			V5_REG_ISP_AFLNSTEP,			0, 0, "[3:0]: AF Step Value." },
	{ V568_REGTYPE, "V5_REG_ISP_TAIL_BLANK_L",		V5_REG_ISP_TAIL_BLANK_L,		0, 0, "Tail Blank (Low)." },
	{ V568_REGTYPE, "V5_REG_ISP_RGAIN",				V5_REG_ISP_RGAIN,				0, 0, "R Digital Gain." },
	{ V568_REGTYPE, "V5_REG_ISP_BGAIN",				V5_REG_ISP_BGAIN,				0, 0, "B Digital Gain." },
	{ V568_REGTYPE, "V5_REG_ISP_GGAIN",				V5_REG_ISP_GGAIN,				0, 0, "G Digital Gain." },
	{ V568_REGTYPE, "V5_REG_ISP_VS_RST_DIS",		V5_REG_ISP_VS_RST_DIS,			0, 0, "[0]: Vsync_reset_disable." },
	{ V568_REGTYPE, "V5_REG_ISP_GLBGAIN",			V5_REG_ISP_GLBGAIN,				0, 0, "Global Gain Value." },
	{ V568_REGTYPE, "V5_REG_ISP_GLBCTL",			V5_REG_ISP_GLBCTL,				0, 0, "[5]: Global Gain Enable;\n[4:2]: Global Gain Delay;\n[1:0]: Global Gain Step." },
	{ V568_REGTYPE, "V5_REG_ISP_CRADJ",				V5_REG_ISP_CRADJ,				0, 0, "Cr Adjustment in RGB->YcbCr convert." },
	{ V568_REGTYPE, "V5_REG_ISP_CBADJ",			    V5_REG_ISP_CBADJ,				0, 0, "Cb Adjustment in RGB->YcbCr convert." },
	{ V568_REGTYPE, "V5_REG_ISP_CROFS",			    V5_REG_ISP_CROFS,				0, 0, "Cr offset in gray image mode." },
	{ V568_REGTYPE, "V5_REG_ISP_CBOFS",				V5_REG_ISP_CBOFS,				0, 0, "Cb offset in gray image mode." },
	{ V568_REGTYPE, "V5_REG_ISP_COLMAT11",			V5_REG_ISP_COLMAT11,			0, 0, "" },
	...
	{ V568_REGTYPE, "V5_REG_ISP_COLOFSR",			V5_REG_ISP_COLOFSR,				0, 0, "[9:0]: R offset of color matrix." },
	{ V568_REGTYPE, "V5_REG_ISP_COLOFSR_H",			V5_REG_ISP_COLOFSR_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_COLOFSG",			V5_REG_ISP_COLOFSG,				0, 0, "[9:0]: G offset of color matrix." },
	{ V568_REGTYPE, "V5_REG_ISP_COLOFSG_H",			V5_REG_ISP_COLOFSG_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_COLOFSB",			V5_REG_ISP_COLOFSB,				0, 0, "[9:0]: B offset of color matrix." },
	{ V568_REGTYPE, "V5_REG_ISP_COLOFSB_H",			V5_REG_ISP_COLOFSB_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP0",			V5_REG_ISP_YGMAP0,				0, 0, "Y Gamma Start 0." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP1",			V5_REG_ISP_YGMAP1,				0, 0, "Y Gamma Start 1." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP2",			V5_REG_ISP_YGMAP2,				0, 0, "Y Gamma Start 2." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP3",			V5_REG_ISP_YGMAP3,				0, 0, "Y Gamma Start 3." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP4",			V5_REG_ISP_YGMAP4,				0, 0, "Y Gamma Start 4." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP5",			V5_REG_ISP_YGMAP5,				0, 0, "Y Gamma Start 5." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP6",			V5_REG_ISP_YGMAP6,				0, 0, "Y Gamma Start 6." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP7",			V5_REG_ISP_YGMAP7,				0, 0, "Y Gamma Start 7." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAP8",			V5_REG_ISP_YGMAP8,				0, 0, "Y Gamma Start 8." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS0",			V5_REG_ISP_YGMAS0,				0, 0, "Y Gamma Slope 0." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS1",			V5_REG_ISP_YGMAS1,				0, 0, "Y Gamma Slope 1." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS2",			V5_REG_ISP_YGMAS2,				0, 0, "Y Gamma Slope 2." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS3",			V5_REG_ISP_YGMAS3,				0, 0, "Y Gamma Slope 3." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS4",			V5_REG_ISP_YGMAS4,				0, 0, "Y Gamma Slope 4." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS5",			V5_REG_ISP_YGMAS5,				0, 0, "Y Gamma Slope 5." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS6",			V5_REG_ISP_YGMAS6,				0, 0, "Y Gamma Slope 6." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS7",			V5_REG_ISP_YGMAS7,				0, 0, "Y Gamma Slope 7." },
	{ V568_REGTYPE, "V5_REG_ISP_YGMAS8",			V5_REG_ISP_YGMAS8,				0, 0, "Y Gamma Slope 8." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS0",			V5_REG_ISP_RGMAS0,				0, 0, "R Gamma Start 0." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS1",			V5_REG_ISP_RGMAS1,				0, 0, "R Gamma Start 1." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS2",			V5_REG_ISP_RGMAS2,				0, 0, "R Gamma Start 2." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS3",			V5_REG_ISP_RGMAS3,				0, 0, "R Gamma Start 3." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS4",			V5_REG_ISP_RGMAS4,				0, 0, "R Gamma Start 4." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS5",			V5_REG_ISP_RGMAS5,				0, 0, "R Gamma Start 5." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS6",			V5_REG_ISP_RGMAS6,				0, 0, "R Gamma Start 6." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS7",			V5_REG_ISP_RGMAS7,				0, 0, "R Gamma Start 7." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS8",			V5_REG_ISP_RGMAS8,				0, 0, "R Gamma Start 8." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS9",			V5_REG_ISP_RGMAS9,				0, 0, "R Gamma Start 9." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS10",			V5_REG_ISP_RGMAS10,				0, 0, "R Gamma Start 10." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS11",			V5_REG_ISP_RGMAS11,				0, 0, "R Gamma Start 11." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS12",			V5_REG_ISP_RGMAS12,				0, 0, "R Gamma Start 12." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS13",			V5_REG_ISP_RGMAS13,				0, 0, "R Gamma Start 13." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS14",			V5_REG_ISP_RGMAS14,				0, 0, "R Gamma Start 14." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS15",			V5_REG_ISP_RGMAS15,				0, 0, "R Gamma Start 15." },
	{ V568_REGTYPE, "V5_REG_ISP_RGMAS16",			V5_REG_ISP_RGMAS16,				0, 0, "R Gamma Start 16." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS0",			V5_REG_ISP_GGMAS0,				0, 0, "G Gamma Start 0." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS1",			V5_REG_ISP_GGMAS1,				0, 0, "G Gamma Start 1." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS2",			V5_REG_ISP_GGMAS2,				0, 0, "G Gamma Start 2." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS3",			V5_REG_ISP_GGMAS3,				0, 0, "G Gamma Start 3." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS4",			V5_REG_ISP_GGMAS4,				0, 0, "G Gamma Start 4." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS5",			V5_REG_ISP_GGMAS5,				0, 0, "G Gamma Start 5." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS6",			V5_REG_ISP_GGMAS6,				0, 0, "G Gamma Start 6." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS7",			V5_REG_ISP_GGMAS7,				0, 0, "G Gamma Start 7." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS8",			V5_REG_ISP_GGMAS8,				0, 0, "G Gamma Start 8." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS9",			V5_REG_ISP_GGMAS9,				0, 0, "G Gamma Start 9." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS10",			V5_REG_ISP_GGMAS10,				0, 0, "G Gamma Start 10." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS11",			V5_REG_ISP_GGMAS11,				0, 0, "G Gamma Start 11." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS12",			V5_REG_ISP_GGMAS12,				0, 0, "G Gamma Start 12." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS13",			V5_REG_ISP_GGMAS13,				0, 0, "G Gamma Start 13." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS14",			V5_REG_ISP_GGMAS14,				0, 0, "G Gamma Start 14." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS15",			V5_REG_ISP_GGMAS15,				0, 0, "G Gamma Start 15." },
	{ V568_REGTYPE, "V5_REG_ISP_GGMAS16",			V5_REG_ISP_GGMAS16,				0, 0, "G Gamma Start 16." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS0",			V5_REG_ISP_BGMAS0,				0, 0, "B Gamma Start 0." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS1",			V5_REG_ISP_BGMAS1,				0, 0, "B Gamma Start 1." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS2",			V5_REG_ISP_BGMAS2,				0, 0, "B Gamma Start 2." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS3",			V5_REG_ISP_BGMAS3,				0, 0, "B Gamma Start 3." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS4",			V5_REG_ISP_BGMAS4,				0, 0, "B Gamma Start 4." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS5",			V5_REG_ISP_BGMAS5,				0, 0, "B Gamma Start 5." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS6",			V5_REG_ISP_BGMAS6,				0, 0, "B Gamma Start 6." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS7",			V5_REG_ISP_BGMAS7,				0, 0, "B Gamma Start 7." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS8",			V5_REG_ISP_BGMAS8,				0, 0, "B Gamma Start 8." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS9",			V5_REG_ISP_BGMAS9,				0, 0, "B Gamma Start 9." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS10",			V5_REG_ISP_BGMAS10,				0, 0, "B Gamma Start 10." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS11",			V5_REG_ISP_BGMAS11,				0, 0, "B Gamma Start 11." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS12",			V5_REG_ISP_BGMAS12,				0, 0, "B Gamma Start 12." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS13",			V5_REG_ISP_BGMAS13,				0, 0, "B Gamma Start 13." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS14",			V5_REG_ISP_BGMAS14,				0, 0, "B Gamma Start 14." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS15",			V5_REG_ISP_BGMAS15,				0, 0, "B Gamma Start 15." },
	{ V568_REGTYPE, "V5_REG_ISP_BGMAS16",			V5_REG_ISP_BGMAS16,				0, 0, "B Gamma Start 16." },
	{ V568_REGTYPE, "V5_REG_ISP_TAIL_BLANK_M",		V5_REG_ISP_TAIL_BLANK_M,		0, 0, "Tail Blank (Middle)." },
	{ V568_REGTYPE, "V5_REG_ISP_TAIL_BLANK_H",		V5_REG_ISP_TAIL_BLANK_H,		0, 0, "[1:0]Tail Blank (High)." },
	{ V568_REGTYPE, "V5_REG_ISP_CTL_AUTO",			V5_REG_ISP_CTL_AUTO,			0, 0, "[7:6]: AE Weight Mode.\n[5]: AE Block Weight.\n[4]: AE Window Weight.\n[3:1]: Auto Function Interrupt Frequency.\n[0]: Anti-Flicker Function Enable." },
	{ V568_REGTYPE, "V5_REG_ISP_CTL_AUTO_H",		V5_REG_ISP_CTL_AUTO_H,			0, 0, "[6]: Edge Extraction Matrix Select.\n[5]: Auto Focus Enable.\n[4]: UV Noise Remove Enable.\n[3]: Y Noise Remove Enable.\n[2]: AWB Window (0: 1 center window; 1: 16 windows).\n[1]: AWB Reverse Mode.\n[0]: AWB Function Enable." },
	{ V568_REGTYPE, "V5_REG_ISP_CTL1",				V5_REG_ISP_CTL1,				0, 0, "[3]: Test Bar Mode Enable.\n[2]: Test Bar Pattern (0: Full Bar; 1:Video Window).\n[1]: Filter Mode.\n[0]: Homochromous Image Enable." },
	{ V568_REGTYPE, "V5_REG_ISP_CTL_UPDATE",		V5_REG_ISP_CTL_UPDATE,			0, 0, "[7]: fem_update.\n[6]: gray_update.\n[5]: colmat_update.\n[4]: rgma_update.\n[3]: ggma_update.\n[2]: bgma_update.\n[1]: dgain_update.\n[0]: glbgain_update." },
	{ V568_REGTYPE, "V5_REG_ISP_YBOT",				V5_REG_ISP_YBOT,				0, 0, "Y Bottom Value Of AWB." },
	{ V568_REGTYPE, "V5_REG_ISP_YTOP",				V5_REG_ISP_YTOP,				0, 0, "Y Top Value Of AWB." },
	{ V568_REGTYPE, "V5_REG_ISP_QTOP",				V5_REG_ISP_QTOP,				0, 0, "Q Top Value Of AWB." },
	{ V568_REGTYPE, "V5_REG_ISP_ITOP",				V5_REG_ISP_ITOP,				0, 0, "I Top Value Of AWB." },
	{ V568_REGTYPE, "V5_REG_ISP_GLOW",				V5_REG_ISP_GLOW,				0, 0, "Minmum RB Gain Value Of AWB." },
	{ V568_REGTYPE, "V5_REG_ISP_GTOP",				V5_REG_ISP_GTOP,				0, 0, "Maximum RB Gain Value Of AWB." },
	...
	{ V568_REGTYPE, "V5_REG_ISP_RMEAN",				V5_REG_ISP_RMEAN,				0, 0, "R mean value of a frame for auto function." },
	{ V568_REGTYPE, "V5_REG_ISP_GMEAN",				V5_REG_ISP_GMEAN,				0, 0, "G mean value of a frame for auto function." },
	{ V568_REGTYPE, "V5_REG_ISP_BMEAN",				V5_REG_ISP_BMEAN,				0, 0, "B mean value of a frame for auto function." },
	{ V568_REGTYPE, "V5_REG_ISP_YMEAN",				V5_REG_ISP_YMEAN,				0, 0, "Y mean value of a frame for auto function." },
	{ V568_REGTYPE, "V5_REG_ISP_AUTO_STATUS",		V5_REG_ISP_AUTO_STATUS,			0, 0, "[7]: Flicker Status (0: Flicker Undetected; 1: Flicker detected).\n[3]: AWB Valid.\n[2]: (1: B mean > G mean , otherwise 0).\n[1]: (1: R mean > G mean , otherwise 0).\n[0]: RG gain reach limitation both." },
	{ V568_REGTYPE, "V5_REG_ISP_DPDTHD",			V5_REG_ISP_DPDTHD,				0, 0, "Y Threshold value of DPC." },
	{ V568_REGTYPE, "V5_REG_ISP_NT0",				V5_REG_ISP_NT0,					0, 0, "Y Noise table factor 0." },
	{ V568_REGTYPE, "V5_REG_ISP_NT1",				V5_REG_ISP_NT1,					0, 0, "Y Noise table factor 1." },
	{ V568_REGTYPE, "V5_REG_ISP_NT2",				V5_REG_ISP_NT2,					0, 0, "Y Noise table factor 2." },
	{ V568_REGTYPE, "V5_REG_ISP_NT3",				V5_REG_ISP_NT3,					0, 0, "Y Noise table factor 3." },
	{ V568_REGTYPE, "V5_REG_ISP_NT4",				V5_REG_ISP_NT4,					0, 0, "Y Noise table factor 4." },
	{ V568_REGTYPE, "V5_REG_ISP_NT5",				V5_REG_ISP_NT5,					0, 0, "Y Noise table factor 5." },
	{ V568_REGTYPE, "V5_REG_ISP_NT6",				V5_REG_ISP_NT6,					0, 0, "Y Noise table factor 6." },
	{ V568_REGTYPE, "V5_REG_ISP_NT7",				V5_REG_ISP_NT7,					0, 0, "Y Noise table factor 7." },
	{ V568_REGTYPE, "V5_REG_ISP_NT8",				V5_REG_ISP_NT8,					0, 0, "Y Noise table factor 8." },
	{ V568_REGTYPE, "V5_REG_ISP_NT9",				V5_REG_ISP_NT9,					0, 0, "Y Noise table factor 9." },
	{ V568_REGTYPE, "V5_REG_ISP_NT10",				V5_REG_ISP_NT10,				0, 0, "Y Noise table factor 10." },
	{ V568_REGTYPE, "V5_REG_ISP_NT11",				V5_REG_ISP_NT11,				0, 0, "Y Noise table factor 11." },
	{ V568_REGTYPE, "V5_REG_ISP_NT12",				V5_REG_ISP_NT12,				0, 0, "Y Noise table factor 12." },
	{ V568_REGTYPE, "V5_REG_ISP_NT13",				V5_REG_ISP_NT13,				0, 0, "Y Noise table factor 13." },
	{ V568_REGTYPE, "V5_REG_ISP_NT14",				V5_REG_ISP_NT14,				0, 0, "Y Noise table factor 14." },
	{ V568_REGTYPE, "V5_REG_ISP_NT15",				V5_REG_ISP_NT15,				0, 0, "Y Noise table factor 15." },
	{ V568_REGTYPE, "V5_REG_ISP_NT16",				V5_REG_ISP_NT16,				0, 0, "Y Noise table factor 16." },
	{ V568_REGTYPE, "V5_REG_ISP_DPDTHD_UV",			V5_REG_ISP_DPDTHD_UV,			0, 0, "UV Threshold value of DPC." },
	{ V568_REGTYPE, "V5_REG_ISP_NT0_UV",			V5_REG_ISP_NT0_UV,				0, 0, "UV Noise table factor 0." },
	{ V568_REGTYPE, "V5_REG_ISP_NT1_UV",			V5_REG_ISP_NT1_UV,				0, 0, "UV Noise table factor 1." },
	{ V568_REGTYPE, "V5_REG_ISP_NT2_UV",			V5_REG_ISP_NT2_UV,				0, 0, "UV Noise table factor 2." },
	{ V568_REGTYPE, "V5_REG_ISP_NT3_UV",			V5_REG_ISP_NT3_UV,				0, 0, "UV Noise table factor 3." },
	{ V568_REGTYPE, "V5_REG_ISP_NT4_UV",			V5_REG_ISP_NT4_UV,				0, 0, "UV Noise table factor 4." },
	{ V568_REGTYPE, "V5_REG_ISP_NT5_UV",			V5_REG_ISP_NT5_UV,				0, 0, "UV Noise table factor 5." },
	{ V568_REGTYPE, "V5_REG_ISP_NT6_UV",			V5_REG_ISP_NT6_UV,				0, 0, "UV Noise table factor 6." },
	{ V568_REGTYPE, "V5_REG_ISP_NT7_UV",			V5_REG_ISP_NT7_UV,				0, 0, "UV Noise table factor 7." },
	{ V568_REGTYPE, "V5_REG_ISP_NT8_UV",			V5_REG_ISP_NT8_UV,				0, 0, "UV Noise table factor 8." },
	{ V568_REGTYPE, "V5_REG_ISP_NT9_UV",			V5_REG_ISP_NT9_UV,				0, 0, "UV Noise table factor 9." },
	{ V568_REGTYPE, "V5_REG_ISP_NT10_UV",			V5_REG_ISP_NT10_UV,				0, 0, "UV Noise table factor 10." },
	{ V568_REGTYPE, "V5_REG_ISP_NT11_UV",			V5_REG_ISP_NT11_UV,				0, 0, "UV Noise table factor 11." },
	{ V568_REGTYPE, "V5_REG_ISP_NT12_UV",			V5_REG_ISP_NT12_UV,				0, 0, "UV Noise table factor 12." },
	{ V568_REGTYPE, "V5_REG_ISP_NT13_UV",			V5_REG_ISP_NT13_UV,				0, 0, "UV Noise table factor 13." },
	{ V568_REGTYPE, "V5_REG_ISP_NT14_UV",			V5_REG_ISP_NT14_UV,				0, 0, "UV Noise table factor 14." },
	{ V568_REGTYPE, "V5_REG_ISP_NT15_UV",			V5_REG_ISP_NT15_UV,				0, 0, "UV Noise table factor 15." },
	{ V568_REGTYPE, "V5_REG_ISP_NT16_UV",			V5_REG_ISP_NT16_UV,				0, 0, "UV Noise table factor 16." },
	{ V568_REGTYPE, "V5_REG_ISP_BL_R_OFFSET",		V5_REG_ISP_BL_R_OFFSET,			0, 0, "[9:0]: Black level offset for R pixel." },
	{ V568_REGTYPE, "V5_REG_ISP_BL_R_OFFSET_H",		V5_REG_ISP_BL_R_OFFSET_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_BL_B_OFFSET",		V5_REG_ISP_BL_B_OFFSET,			0, 0, "[9:0]: Black level offset for B pixel." },
	{ V568_REGTYPE, "V5_REG_ISP_BL_B_OFFSET_H",		V5_REG_ISP_BL_B_OFFSET_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_BL_G1_OFFSET",		V5_REG_ISP_BL_G1_OFFSET,		0, 0, "[9:0]: Black level offset for G1 pixel." },
	{ V568_REGTYPE, "V5_REG_ISP_BL_G1_OFFSET_H",	V5_REG_ISP_BL_G1_OFFSET_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_BL_G2_OFFSET",		V5_REG_ISP_BL_G2_OFFSET,		0, 0, "[9:0]: Black level offset for G2 pixel." },
	{ V568_REGTYPE, "V5_REG_ISP_BL_G2_OFFSET_H",	V5_REG_ISP_BL_G2_OFFSET_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_EDGE_SUM_L",		V5_REG_ISP_EDGE_SUM_L,			0, 0, "[30:0]: Edge sum for auto focus." },
	...
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_HPOS_0",	V5_REG_ISP_AEAWB_WIN_HPOS_0,	0, 0, "AWB/AE Window Horizontal Position." },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_HPOS_1",	V5_REG_ISP_AEAWB_WIN_HPOS_1,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_HPOS_2",	V5_REG_ISP_AEAWB_WIN_HPOS_2,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_HPOS_3",	V5_REG_ISP_AEAWB_WIN_HPOS_3,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_HPOS_4",	V5_REG_ISP_AEAWB_WIN_HPOS_4,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_VPOS_0",	V5_REG_ISP_AEAWB_WIN_VPOS_0,	0, 0, "AWB/AE Window Vertical Position." },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_VPOS_1",	V5_REG_ISP_AEAWB_WIN_VPOS_1,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_VPOS_2",	V5_REG_ISP_AEAWB_WIN_VPOS_2,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_VPOS_3",	V5_REG_ISP_AEAWB_WIN_VPOS_3,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AEAWB_WIN_VPOS_4",	V5_REG_ISP_AEAWB_WIN_VPOS_4,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_HIS_CTRL",			V5_REG_ISP_HIS_CTRL,			0, 0, "[1]: Manual Adjusting Enable.\n[0]: Histogram Balance Enable Control." },
	{ V568_REGTYPE, "V5_REG_ISP_HIS_MANUAL_GAIN",	V5_REG_ISP_HIS_MANUAL_GAIN,		0, 0, "The manually adjustable histogram gain." },
	{ V568_REGTYPE, "V5_REG_ISP_Y_MEAN_TGT",		V5_REG_ISP_Y_MEAN_TGT,			0, 0, "Y_mean target." },
	{ V568_REGTYPE, "V5_REG_ISP_Y_MEAN_THD",		V5_REG_ISP_Y_MEAN_THD,			0, 0, "The threshold value between the y_mean and y_mean target." },
	{ V568_REGTYPE, "V5_REG_ISP_INTERRUPT",			V5_REG_ISP_INTERRUPT,			0, 0, "Interrupt flag.\n[2]: y_mean_int.\n[1]: antif_int.\n[0]: auto_foc_int." },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_0",			V5_REG_ISP_AE_WT_0,				0, 0, "Separate weight value for 16 windows." },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_1",			V5_REG_ISP_AE_WT_1,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_2",			V5_REG_ISP_AE_WT_2,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_3",			V5_REG_ISP_AE_WT_3,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_4",			V5_REG_ISP_AE_WT_4,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_5",			V5_REG_ISP_AE_WT_5,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_6",			V5_REG_ISP_AE_WT_6,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_AE_WT_7",			V5_REG_ISP_AE_WT_7,				0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_WIN_YMEAN_11",		V5_REG_ISP_WIN_YMEAN_11,		0, 0, "Y mean for 16 windows." },
	...
	{ V568_REGTYPE, "V5_REG_ISP_HUE_EN",			V5_REG_ISP_HUE_EN,				0, 0, "[0]: Hue & Saturation Enable." },
	{ V568_REGTYPE, "V5_REG_ISP_HUE_COS",			V5_REG_ISP_HUE_COS,				0, 0, "[9:0]: Hue cosine parameter." },
	{ V568_REGTYPE, "V5_REG_ISP_HUE_COS_H",			V5_REG_ISP_HUE_COS_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_HUE_SIN",			V5_REG_ISP_HUE_SIN,				0, 0, "[9:0]: Hue sine parameter." },
	{ V568_REGTYPE, "V5_REG_ISP_HUE_SIN_H",			V5_REG_ISP_HUE_SIN_H,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_ISP_SATURATION",		V5_REG_ISP_SATURATION,			0, 0, "Saturation parameter." },
	{ V568_REGTYPE, "V5_REG_ISP_HUE_YOFF",			V5_REG_ISP_HUE_YOFF,			0, 0, "[8:0]: Brightness adjust: y offset." },
	{ V568_REGTYPE, "V5_REG_ISP_HUE_UOFF",			V5_REG_ISP_HUE_UOFF,			0, 0, "[8:0]: Hue adjust: u offset." },
	{ V568_REGTYPE, "V5_REG_ISP_HUE_VOFF",			V5_REG_ISP_HUE_VOFF,			0, 0, "[8:0]: Hue adjust: v offset." },
	{ V568_REGTYPE, "V5_REG_ISP_RESET",				V5_REG_ISP_RESET,				0, 0, "[1]: Reset registers of ISP.\n[0]: Reset ISP module except registers." }
};

static const TRegUnit gIppReg[] =
{
	{ V568_REGTYPE, "V5_REG_IPP_SPECTRL",		V5_REG_IPP_SPECTRL,		0, 0, "[6:5]: IPP working mode.\n[4:1]: Special effect select.\n[0]: Special effect enable." },
	{ V568_REGTYPE, "V5_REG_IPP_SIZCTRL0",		V5_REG_IPP_SIZCTRL0,	0, 0, "[7]; Frame Enable.\n[6:5]; Input image data select.\n[4]; IPP reset.\n[3]; Display sizer enable.\n[2]; Capture down sizer enable.\n[1]; Capture up sizer enable.\n[0]; Thumbnail sizer enable." },
	{ V568_REGTYPE, "V5_REG_IPP_IMGWD",			V5_REG_IPP_IMGWD,		0, 0, "[11:0]: width of the input image." },
	{ V568_REGTYPE, "V5_REG_IPP_IMGWD_H",		V5_REG_IPP_IMGWD_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_IMGHT",			V5_REG_IPP_IMGHT,		0, 0, "[11:0]: height of the input image." },
	{ V568_REGTYPE, "V5_REG_IPP_IMGHT_H",		V5_REG_IPP_IMGHT_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_WINWD",			V5_REG_IPP_WINWD,		0, 0, "[11:0]: width of the image window." },
	{ V568_REGTYPE, "V5_REG_IPP_WINWD_H",		V5_REG_IPP_WINWD_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_WINHT",			V5_REG_IPP_WINHT,		0, 0, "[11:0]: height of the image window." },
	{ V568_REGTYPE, "V5_REG_IPP_WINHT_H",		V5_REG_IPP_WINHT_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_WINSTX",		V5_REG_IPP_WINSTX,		0, 0, "[11:0]: horizontal coordinate of window start pixel." },
	{ V568_REGTYPE, "V5_REG_IPP_WINSTX_H",		V5_REG_IPP_WINSTX_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_WINSTY",		V5_REG_IPP_WINSTY,		0, 0, "[11:0]: vertical coordinate of window start pixel." },
	{ V568_REGTYPE, "V5_REG_IPP_WINSTY_H",		V5_REG_IPP_WINSTY_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISWD",			V5_REG_IPP_DISWD,		0, 0, "[9:0]: width of the output image from the display sizer." },
	{ V568_REGTYPE, "V5_REG_IPP_DISWD_H",		V5_REG_IPP_DISWD_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISHT",			V5_REG_IPP_DISHT,		0, 0, "[9:0]: height of the output image from the display sizer." },
	{ V568_REGTYPE, "V5_REG_IPP_DISHT_H",		V5_REG_IPP_DISHT_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISH_W1",		V5_REG_IPP_DISH_W1,		0, 0, "[6:0]: display sizer source image horizontal ratio w1." },
	{ V568_REGTYPE, "V5_REG_IPP_DISH_W2",		V5_REG_IPP_DISH_W2,		0, 0, "[6:0]: display sizer source image horizontal ratio w2." },
	{ V568_REGTYPE, "V5_REG_IPP_DISH_S1",		V5_REG_IPP_DISH_S1,		0, 0, "display sizer horizontal multiplicator  1/s1 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_DISH_S1_H",		V5_REG_IPP_DISH_S1_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISH_S2",		V5_REG_IPP_DISH_S2,		0, 0, "display sizer horizontal multiplicator  1/s2 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_DISH_S2_H",		V5_REG_IPP_DISH_S2_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISH_C",		V5_REG_IPP_DISH_C,		0, 0, "[6:0]: display sizer horizontal arithmetical compliment c = w2-w1%w2." },
	{ V568_REGTYPE, "V5_REG_IPP_DISV_H1",		V5_REG_IPP_DISV_H1,		0, 0, "[6:0]: display sizer source image vertical ratio h1." },
	{ V568_REGTYPE, "V5_REG_IPP_DISV_H2",		V5_REG_IPP_DISV_H2,		0, 0, "[6:0]: display sizer source image vertical ratio h2." },
	{ V568_REGTYPE, "V5_REG_IPP_DISV_S1",		V5_REG_IPP_DISV_S1,		0, 0, "display sizer vertical multiplicator  1/s1 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_DISV_S1_H",		V5_REG_IPP_DISV_S1_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISV_S2",		V5_REG_IPP_DISV_S2,		0, 0, "display sizer vertical multiplicator  1/s2 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_DISV_S2_H",		V5_REG_IPP_DISV_S2_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISV_C",		V5_REG_IPP_DISV_C,		0, 0, "[6:0]: display sizer vertical arithmetical compliment c = h2-h1%h2." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPWD",			V5_REG_IPP_CAPWD,		0, 0, "[11:0]: width of the output image from the capture sizer." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPWD_H",		V5_REG_IPP_CAPWD_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_CAPHT",			V5_REG_IPP_CAPHT,		0, 0, "[11:0]: height of the output image from the capture sizer." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPHT_H",		V5_REG_IPP_CAPHT_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDH_W1",		V5_REG_IPP_CAPDH_W1,	0, 0, "[6:0]: capture down horizontal sizer ratio w1." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDH_W2",		V5_REG_IPP_CAPDH_W2,	0, 0, "[6:0]: capture down horizontal sizer ratio w2." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDH_S1",		V5_REG_IPP_CAPDH_S1,	0, 0, "capture scale down sizer horizontal multiplicator  1/s1 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDH_S1_H",	V5_REG_IPP_CAPDH_S1_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDH_S2",		V5_REG_IPP_CAPDH_S2,	0, 0, "capture scale down sizer horizontal multiplicator  1/s2 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDH_S2_H",	V5_REG_IPP_CAPDH_S2_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDH_C",		V5_REG_IPP_CAPDH_C,		0, 0, "[6:0]: capture scale down sizer horizontal arithmetical compliment c = w2-w1%w2." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDV_H1",		V5_REG_IPP_CAPDV_H1,	0, 0, "[6:0]: capture scale down sizer source image horizontal ratio h1." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDV_H2",		V5_REG_IPP_CAPDV_H2,	0, 0, "[6:0]: capture scale down sizer source image horizontal ratio h2." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDV_S1",		V5_REG_IPP_CAPDV_S1,	0, 0, "capture scale down sizer vertical multiplicator  1/s1 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDV_S1_H",	V5_REG_IPP_CAPDV_S1_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDV_S2",		V5_REG_IPP_CAPDV_S2,	0, 0, "capture scale down sizer vertical multiplicator  1/s2 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDV_S2_H",	V5_REG_IPP_CAPDV_S2_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_CAPDV_C",		V5_REG_IPP_CAPDV_C,		0, 0, "[6:0]: capture scale down sizer vertical arithmetical compliment c = h2-h1%h2." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUH_W1",		V5_REG_IPP_CAPUH_W1,	0, 0, "capture scale up horizontal sizer ratio w1." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUH_W2",		V5_REG_IPP_CAPUH_W2,	0, 0, "capture scale up horizontal sizer ratio w2." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUH_S",		V5_REG_IPP_CAPUH_S,		0, 0, "capture scale up sizer horizontal multiplicator  s=(1/w2) * 65536 ." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUH_S_H",		V5_REG_IPP_CAPUH_S_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUV_H1",		V5_REG_IPP_CAPUV_H1,	0, 0, "capture scale up vertical sizer ratio h1." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUV_H2",		V5_REG_IPP_CAPUV_H2,	0, 0, "capture scale up vertical sizer ratio h2." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUV_S",		V5_REG_IPP_CAPUV_S,		0, 0, "capture scale up sizer vertical multiplicator  s=(1/h2) * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPUV_S_H",		V5_REG_IPP_CAPUV_S_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_THUMB_WD",		V5_REG_IPP_THUMB_WD,	0, 0, "Thumbnail height." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMB_HT",		V5_REG_IPP_THUMB_HT,	0, 0, "Thumbnail width." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBH_W1",		V5_REG_IPP_THUMBH_W1,	0, 0, "[6:0]: thumbnail horizontal sizer ratio w1." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBH_W2",		V5_REG_IPP_THUMBH_W2,	0, 0, "[6:0]: thumbnail horizontal sizer ratio w2." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBH_S1",		V5_REG_IPP_THUMBH_S1,	0, 0, "thumbnail sizer horizontal multiplicator  1/s1 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBH_S1_H",	V5_REG_IPP_THUMBH_S1_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBH_S2",		V5_REG_IPP_THUMBH_S2,	0, 0, "thumbnail sizer horizontal multiplicator  1/s2 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBH_S2_H",	V5_REG_IPP_THUMBH_S2_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBH_C",		V5_REG_IPP_THUMBH_C,	0, 0, "[6:0]: thumbnail sizer horizontal arithmetical compliment c = w2-w1%w2." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBV_H1",		V5_REG_IPP_THUMBV_H1,	0, 0, "[6:0]: thumbnail vertical sizer ratio h1." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBV_H2",		V5_REG_IPP_THUMBV_H2,	0, 0, "[6:0]: thumbnail vertical sizer ratio h2." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBV_S1",		V5_REG_IPP_THUMBV_S1,	0, 0, "thumbnail sizer vertical multiplicator  1/s1 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBV_S1_H",	V5_REG_IPP_THUMBV_S1_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBV_S2",		V5_REG_IPP_THUMBV_S2,	0, 0, "thumbnail sizer vertical multiplicator  1/s2 * 65536." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBV_S2_H",	V5_REG_IPP_THUMBV_S2_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_THUMBV_C",		V5_REG_IPP_THUMBV_C,	0, 0, "[6:0]: thumbnail sizer vertical arithmetical compliment c = h2-h1%h2." },
	{ V568_REGTYPE, "V5_REG_IPP_THUMB_INPUT",	V5_REG_IPP_THUMB_INPUT,	0, 0, "[1:0]: thumbnail sizer input select." },
	{ V568_REGTYPE, "V5_REG_IPP_SIZCTRL1",		V5_REG_IPP_SIZCTRL1,	0, 0, "[7]: capture scale down horizontal sizer bypass enable.\n[6]: capture scale down vertical sizer bypass enable.\n[5]: capture scale up horizontal sizer bypass enable.\n[4]: capture scale up vertical sizer bypass enable.\n[3]: display horizontal sizer bpass enable.\n[2]: display vertical sizer bpass enable.\n[1]: thumbnail horizontal sizer bypass enable.\n[0]: thumbnail vertical sizer bypass enable." },
	{ V568_REGTYPE, "V5_REG_IPP_UOFFSET",		V5_REG_IPP_UOFFSET,		0, 0, "U offset for sephia effect." },
	{ V568_REGTYPE, "V5_REG_IPP_VOFFSET",		V5_REG_IPP_VOFFSET,		0, 0, "V offset for sephia effect." },
	{ V568_REGTYPE, "V5_REG_IPP_UUPTHRS",		V5_REG_IPP_UUPTHRS,		0, 0, "U up threshold value for special color effect." },
	{ V568_REGTYPE, "V5_REG_IPP_UDWTHRS",		V5_REG_IPP_UDWTHRS,		0, 0, "U down threshold value for special color effect." },
	{ V568_REGTYPE, "V5_REG_IPP_VUPTHRS",		V5_REG_IPP_VUPTHRS,		0, 0, "V up threshold value for special color effect." },
	{ V568_REGTYPE, "V5_REG_IPP_VDWTHRS",		V5_REG_IPP_VDWTHRS,		0, 0, "V down threshold value for special color effect." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPFRMDP",		V5_REG_IPP_CAPFRMDP,	0, 0, "Capture Frame Drop." },
	{ V568_REGTYPE, "V5_REG_IPP_CAPFRMDP_H",	V5_REG_IPP_CAPFRMDP_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_DISFRMDP",		V5_REG_IPP_DISFRMDP,	0, 0, "Display Frame Drop." },
	{ V568_REGTYPE, "V5_REG_IPP_DISFRMDP_H",	V5_REG_IPP_DISFRMDP_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_EN",		V5_REG_IPP_HIST_EN,		0, 0, "[0]: Histogram enable." },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_IN_SEL",	V5_REG_IPP_HIST_IN_SEL,	0, 0, "[1:0]: Histogram input select." },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_X_CUR",	V5_REG_IPP_HIST_X_CUR,	0, 0, "X_cur." },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_X_AVG",	V5_REG_IPP_HIST_X_AVG,	0, 0, "X_avg." },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_Q_L",		V5_REG_IPP_HIST_Q_L,	0, 0, "[18:0]: Q value." },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_Q_M",		V5_REG_IPP_HIST_Q_M,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_Q_H",		V5_REG_IPP_HIST_Q_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_00",	V5_REG_IPP_HIST_RLT_00,	0, 0, "Histogram Sum Value." },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_08",	V5_REG_IPP_HIST_RLT_08,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_10",	V5_REG_IPP_HIST_RLT_10,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_18",	V5_REG_IPP_HIST_RLT_18,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_20",	V5_REG_IPP_HIST_RLT_20,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_28",	V5_REG_IPP_HIST_RLT_28,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_30",	V5_REG_IPP_HIST_RLT_30,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_38",	V5_REG_IPP_HIST_RLT_38,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_40",	V5_REG_IPP_HIST_RLT_40,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_48",	V5_REG_IPP_HIST_RLT_48,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_50",	V5_REG_IPP_HIST_RLT_50,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_58",	V5_REG_IPP_HIST_RLT_58,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_60",	V5_REG_IPP_HIST_RLT_60,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_68",	V5_REG_IPP_HIST_RLT_68,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_70",	V5_REG_IPP_HIST_RLT_70,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_78",	V5_REG_IPP_HIST_RLT_78,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_80",	V5_REG_IPP_HIST_RLT_80,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_88",	V5_REG_IPP_HIST_RLT_88,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_90",	V5_REG_IPP_HIST_RLT_90,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_98",	V5_REG_IPP_HIST_RLT_98,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_A0",	V5_REG_IPP_HIST_RLT_A0,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_A8",	V5_REG_IPP_HIST_RLT_A8,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_B0",	V5_REG_IPP_HIST_RLT_B0,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_B8",	V5_REG_IPP_HIST_RLT_B8,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_C0",	V5_REG_IPP_HIST_RLT_C0,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_C8",	V5_REG_IPP_HIST_RLT_C8,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_D0",	V5_REG_IPP_HIST_RLT_D0,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_D8",	V5_REG_IPP_HIST_RLT_D8,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_E0",	V5_REG_IPP_HIST_RLT_E0,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_E8",	V5_REG_IPP_HIST_RLT_E8,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_F0",	V5_REG_IPP_HIST_RLT_F0,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_HIST_RLT_F8",	V5_REG_IPP_HIST_RLT_F8,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_IPP_TSIZER_OUT",	V5_REG_IPP_TSIZER_OUT,	0, 0, "[0]: Thumbnail sizer output YUV422 or RGB565 selection." }
};
...
static const TRegUnit gLcdIFReg[] =
{
	...
	{ V568_REGTYPE, "V5_REG_LCDIF_HEAD_PROC_FLG",	V5_REG_LCDIF_HEAD_PROC_FLG,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_START_X",	V5_REG_LCDIF_COMM_START_X,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_START_X_H",	V5_REG_LCDIF_COMM_START_X_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_END_X",		V5_REG_LCDIF_COMM_END_X,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_END_X_H",	V5_REG_LCDIF_COMM_END_X_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_START_X",		V5_REG_LCDIF_RPT_START_X,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_START_X_H",	V5_REG_LCDIF_RPT_START_X_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_START_Y",		V5_REG_LCDIF_RPT_START_Y,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_START_Y_H",	V5_REG_LCDIF_RPT_START_Y_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_END_X",		V5_REG_LCDIF_RPT_END_X,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_END_X_H",		V5_REG_LCDIF_RPT_END_X_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_END_Y",		V5_REG_LCDIF_RPT_END_Y,			0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_RPT_END_Y_H",		V5_REG_LCDIF_RPT_END_Y_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_START_Y",	V5_REG_LCDIF_COMM_START_Y,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_START_Y_H",	V5_REG_LCDIF_COMM_START_Y_H,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_END_Y",		V5_REG_LCDIF_COMM_END_Y,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDIF_COMM_END_Y_H",	V5_REG_LCDIF_COMM_END_Y_H,		0, 0, "" }
};

static const TRegUnit gJpegReg[] =
{
	{ V568_REGTYPE, "V5_REG_JPEG_JPEG_MODE		",		V5_REG_JPEG_JPEG_MODE		,			0,	0,	"JPEG mode register,\n[7]: enhanced brc enable\n[6]: avi format enable\n[5]: use custom Huffman table\n[4]: display video\n[3]: use custom quantization table\n[2]: simple header enable\n[1:0]: working mode:0-capture,0-display,0-encode,0-decode"},
	...
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_THD_R1			",	V5_REG_JPEG_ENH_THD_R1			,		0,	0,	"[6:0]: the threshold at level one for the shift right"},
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_THD_R2			",	V5_REG_JPEG_ENH_THD_R2			,		0,	0,	"[6:0]: the threshold at level two for the shift right"},
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_THD_L1			",	V5_REG_JPEG_ENH_THD_L1			,		0,	0,	"[6:0]: the threshold at level one for the shift left"},
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_THD_L2			",	V5_REG_JPEG_ENH_THD_L2			,		0,	0,	"[6:0]: the threshold at level two for the shift left"},
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_SHF_NBIT_R1	",	V5_REG_JPEG_ENH_SHF_NBIT_R1		,		0,	0,	"[5:0]: the shift bit at level one for the shift right"},
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_SHF_NBIT_R2	",	V5_REG_JPEG_ENH_SHF_NBIT_R2		,		0,	0,	"[5:0]: the shift bit at level two for the shift right"},
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_SHF_NBIT_L1	",	V5_REG_JPEG_ENH_SHF_NBIT_L1		,		0,	0,	"[5:0]: the shift bit at level one for the shift left"},
	{ V568_REGTYPE, "V5_REG_JPEG_ENH_SHF_NBIT_L2	",	V5_REG_JPEG_ENH_SHF_NBIT_L2		,		0,	0,	"[5:0]: the shift bit at level two for the shift  left"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_QF_LEVEL0_COMP",	V5_REG_JPEG_RUDE_QF_LEVEL0_COMP	,		0,	0,	"[6:0]: the compensative qf at level zero when the rude brc strategy is active in the last frame"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_QF_LEVEL1_COMP",	V5_REG_JPEG_RUDE_QF_LEVEL1_COMP	,		0,	0,	"[6:0]: the compensative qf at level one when the rude brc strategy is active in the last frame"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_QF_LEVEL2_COMP",	V5_REG_JPEG_RUDE_QF_LEVEL2_COMP	,		0,	0,	"[6:0]: the compensative qf at level two when the rude brc strategy is active in the last frame"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_QF_LEVEL3_COMP",	V5_REG_JPEG_RUDE_QF_LEVEL3_COMP	,		0,	0,	"[6:0]: the compensative qf at level three when the rude brc strategy is active in the last frame"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_QF_LEVEL4_COMP",	V5_REG_JPEG_RUDE_QF_LEVEL4_COMP	,		0,	0,	"[6:0]: the compensative qf at level four when the rude brc strategy is active in the last frame"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_QF_LEVEL5_COMP",	V5_REG_JPEG_RUDE_QF_LEVEL5_COMP	,		0,	0,	"[6:0]: the compensative qf at level five when the rude brc strategy is active in the last frame"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_BRC			",	V5_REG_JPEG_RUDE_BRC			,		0,	0,	"[7]:rude_brc_en\n[6]:uv_only_en\n[5:0]:rude_ac"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_LEVEL			",	V5_REG_JPEG_RUDE_LEVEL			,		0,	0,	"[1:0]: rude_level"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_THD_WC_0		",	V5_REG_JPEG_RUDE_THD_WC_0		,		0,	0,	"the threshold word count for rude strategy[31:24]"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_THD_WC_1		",	V5_REG_JPEG_RUDE_THD_WC_1		,		0,	0,	"the threshold word count for rude strategy[23:16]"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_THD_WC_2		",	V5_REG_JPEG_RUDE_THD_WC_2		,		0,	0,	"the threshold word count for rude strategy[15:8]"},
	{ V568_REGTYPE, "V5_REG_JPEG_RUDE_THD_WC_3		",	V5_REG_JPEG_RUDE_THD_WC_3		,		0,	0,	"the threshold word count for rude strategy[7:0]"},
	{ V568_REGTYPE, "V5_REG_JPEG_TIMER_VALUE_0		",	V5_REG_JPEG_TIMER_VALUE_0		,		0,	0,	"Time value is used when display video which is compressed by our jpeg engine[31:24]"},
	{ V568_REGTYPE, "V5_REG_JPEG_TIMER_VALUE_1		",	V5_REG_JPEG_TIMER_VALUE_1		,		0,	0,	"Time value is used when display video which is compressed by our jpeg engine[23:16]"},
	{ V568_REGTYPE, "V5_REG_JPEG_TIMER_VALUE_2		",	V5_REG_JPEG_TIMER_VALUE_2		,		0,	0,	"Time value is used when display video which is compressed by our jpeg engine[15:8]"},
	{ V568_REGTYPE, "V5_REG_JPEG_TIMER_VALUE_3		",	V5_REG_JPEG_TIMER_VALUE_3		,		0,	0,	"Time value is used when display video which is compressed by our jpeg engine[7:0]"}
...
static const TRegUnit gLbufReg[] =
{
	...
	{ V568_REGTYPE, "V5_REG_LBUF_CAP_DLY_H",		V5_REG_LBUF_CAP_DLY_H,			0,	0,	"Capture capture delay\n [15] select enable.\n [14:0]: delay value"},
	{ V568_REGTYPE, "V5_REG_LBUF_CAP_DLY_L",		V5_REG_LBUF_CAP_DLY_L,			0,	0,	""}
};
...
static const TRegUnit gLcdcReg[] =
{
	...
	{ V568_REGTYPE, "V5_REG_LCDC_BX0_L",		V5_REG_LCDC_BX0_L,		0, 0, "X coordinates of Layer-B display position on the LCD screen.(0-0x1ff)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BX0_H",		V5_REG_LCDC_BX0_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_BY0_L",		V5_REG_LCDC_BY0_L,		0, 0, "Y coordinates of Layer-B display position on the LCD screen.(0-0x1ff)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BY0_H",		V5_REG_LCDC_BY0_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_BW0_L",		V5_REG_LCDC_BW0_L,		0, 0, "Width of Layer-B window on the LCD screen.(0-0x1ff)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BW0_H",		V5_REG_LCDC_BW0_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_BH0_L",		V5_REG_LCDC_BH0_L,		0, 0, "Height of Layer-B window on the LCD screen.(0-0x1ff)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BH0_H",		V5_REG_LCDC_BH0_H,		0, 0, "" },
	...
	{ V568_REGTYPE, "V5_REG_LCDC_BRX0_L",		V5_REG_LCDC_BRX0_L,		0, 0, "X coordinate of the top-left corner of the block to be refreshed in Layer-B.(0-0x1ff)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BRX0_H",		V5_REG_LCDC_BRX0_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_BRY0_L",		V5_REG_LCDC_BRY0_L,		0, 0, "Y coordinate of the top-left corner of the block to be refreshed in Layer-B.(0-0x1ff)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BRY0_H",		V5_REG_LCDC_BRY0_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_BRW0_L",		V5_REG_LCDC_BRW0_L,		0, 0, "Width of the Layer-B refresh block in pixel unit.(0-0x1fe)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BRW0_H",		V5_REG_LCDC_BRW0_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_BRH0_L",		V5_REG_LCDC_BRH0_L,		0, 0, "Height of the Layer-B refresh block in pixel unit. (0-0x1ff)" },
	{ V568_REGTYPE, "V5_REG_LCDC_BRH0_H",		V5_REG_LCDC_BRH0_H,		0, 0, "" },
	...
	{ V568_REGTYPE, "V5_REG_LCDC_OKC0_L",		V5_REG_LCDC_OKC0_L,		0, 0, "Overlay key color." },
	{ V568_REGTYPE, "V5_REG_LCDC_OKC0_M",		V5_REG_LCDC_OKC0_M,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_OKC0_H",		V5_REG_LCDC_OKC0_H,		0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_OKCM0",		V5_REG_LCDC_OKCM0,		0, 0, "1'[24]: Overlay key color mode." },
	{ V568_REGTYPE, "V5_REG_LCDC_BR0_L",		V5_REG_LCDC_BR0_L,		0, 0, "Blend Ratio." },
	{ V568_REGTYPE, "V5_REG_LCDC_BR0_H",		V5_REG_LCDC_BR0_H,		0, 0, "" },
	...
	{ V568_REGTYPE, "V5_REG_LCDC_BX1_L",		V5_REG_LCDC_BX1_L,	0, 0, "X coordinates of Layer-B1 display position on the LCD screen.(0-0x1ff)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BX1_H",		V5_REG_LCDC_BX1_H,	0, 0, "" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BY1_L",		V5_REG_LCDC_BY1_L,	0, 0, "Y coordinates of Layer-B1 display position on the LCD screen.(0-0x1ff)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BY1_H",		V5_REG_LCDC_BY1_H,	0, 0, "" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BW1_L",		V5_REG_LCDC_BW1_L,	0, 0, "Width of Layer-B1 window on the LCD screen.(0-0x1ff)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BW1_H",		V5_REG_LCDC_BW1_H,	0, 0, "" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BH1_L",		V5_REG_LCDC_BH1_L,	0, 0, "Height of Layer-B1 window on the LCD screen.(0-0x1ff)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BH1_H",		V5_REG_LCDC_BH1_H,	0, 0, "" },	

	{ V568_REGTYPE, "V5_REG_LCDC_BRX1_L",		V5_REG_LCDC_BRX1_L,	0, 0, "X coordinate of the top-left corner of the block to be refreshed in Layer-B1.(0-0x1ff)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BRX1_H",		V5_REG_LCDC_BRX1_H,	0, 0, "" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BRY1_L",		V5_REG_LCDC_BRY1_L,	0, 0, "Y coordinate of the top-left corner of the block to be refreshed in Layer-B1.(0-0x1ff)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BRY1_H",		V5_REG_LCDC_BRY1_H,	0, 0, "" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BRW1_L",		V5_REG_LCDC_BRW1_L,	0, 0, "Width of the Layer-B1 refresh block in pixel unit.(0-0x1fe)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BRW1_H",		V5_REG_LCDC_BRW1_H,	0, 0, "" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BRH1_L",		V5_REG_LCDC_BRH1_L,	0, 0, "Height of the Layer-B1 refresh block in pixel unit. (0-0x1ff)" },	
	{ V568_REGTYPE, "V5_REG_LCDC_BRH1_H",		V5_REG_LCDC_BRH1_H,	0, 0, "" },

	{ V568_REGTYPE, "V5_REG_LCDC_OKC1_L",		V5_REG_LCDC_OKC1_L,	0, 0, "Overlay key color for Layer-B1" },
	{ V568_REGTYPE, "V5_REG_LCDC_OKC1_M",		V5_REG_LCDC_OKC1_M,	0, 0, "" },
	{ V568_REGTYPE, "V5_REG_LCDC_OKC1_H",		V5_REG_LCDC_OKC1_H,	0, 0, "" },

	{ V568_REGTYPE, "V5_REG_LCDC_OKCM1",		V5_REG_LCDC_OKCM1,	0, 0, "1'[24]: Overlay key color mode." },

	{ V568_REGTYPE, "V5_REG_LCDC_BR1_L",		V5_REG_LCDC_BR1_L,	0, 0, "Blend Ratio for Layer-B1" },
	{ V568_REGTYPE, "V5_REG_LCDC_BR1_H",		V5_REG_LCDC_BR1_H,	0, 0, "" }
};

static const TRegUnit gMarbReg[] =
{
	{ V568_REGTYPE, "V5_REG_MARB_MARB_CTRL	",		V5_REG_MARB_MARB_CTRL	,			0,	0,	"MARB control register1, clear by hardware \n[0]: reserved\n[1]: start capture\n[2]: stop capture avi\n[3]: start decoder\n[4]: update priority\n[5]:  host_start_timer\n[6]:  host_stop_timer\n[7]:  timer_counter_lock"},
	...
	{ V568_REGTYPE, "V5_REG_MARB_MODE_CTRL_1",		V5_REG_MARB_MODE_CTRL_1	,			0,	0,	"JPEG buffer control register\n[0]: JPEG buffer type\n0: FIFO, care host read/write point\n1: buffer, doesn＊t care host read/write point\n[1]: thumbnail buffer type\n0: FIFO, care host read/write point\n1: buffer, doesn＊t care host read/write point\n[2] : capture_video_auto_stop_en\n0: stop_capture is controlled by host\n1: stop_capture trigger by timer\n[3] : timer_restart_mode\n0: timer restart by host\n1: timer always restart automatically\n[4] : Recap Error operate 0: No operate 1: Reset marb"},
	...
	{ V568_REGTYPE, "V5_REG_MARB_CLK32_DIV_0",		V5_REG_MARB_CLK32_DIV_0,			0,	0,	"\nThe register to generate 32KHz clock for 1T-sram,\nthe value should be (Fclk/32K)/2 - 1"},
	{ V568_REGTYPE, "V5_REG_MARB_CLK32_DIV_1",		V5_REG_MARB_CLK32_DIV_1,			0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_1T_CTRL1",			V5_REG_MARB_1T_CTRL1,				0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_RECAP_CTRL",		V5_REG_MARB_RECAP_CTRL,				0,	0,	"\n[0] overflow_recap_en\n[1] fifierr_recap_en"},
	{ V568_REGTYPE, "V5_REG_MARB_RECAP_THRESHOLD",	V5_REG_MARB_RECAP_THRESHOLD,		0,	0,	"[7:0] threshold for recapture"},
	{ V568_REGTYPE, "V5_REG_MARB_RECAP_TIMES",		V5_REG_MARB_RECAP_TIMES,			0,	0,	"[7:0] indicates how many times recap occured"},
	{ V568_REGTYPE, "V5_REG_MARB_RECAP_FRM_SIZE0",	V5_REG_MARB_RECAP_FRM_SIZE0,		0,	0,	"Recap_frame_size0-3 indicate the threshold of one frame"},
	{ V568_REGTYPE, "V5_REG_MARB_RECAP_FRM_SIZE1",	V5_REG_MARB_RECAP_FRM_SIZE1,		0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_RECAP_FRM_SIZE2",	V5_REG_MARB_RECAP_FRM_SIZE2,		0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_RECAP_FRM_SIZE3",	V5_REG_MARB_RECAP_FRM_SIZE3,		0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_REF_MEET_POINT",	V5_REG_MARB_REF_MEET_POINT,			0,	0,	"The max continuous non-idle cycle of 1T-sram"},
	{ V568_REGTYPE, "V5_REG_MARB_TIMER0",			V5_REG_MARB_TIMER0,					0,	0,	"Interval of timer"},
	{ V568_REGTYPE, "V5_REG_MARB_TIMER1",			V5_REG_MARB_TIMER1,					0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_TIMER2",			V5_REG_MARB_TIMER2,					0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_SUB_TIMER0",		V5_REG_MARB_SUB_TIMER0,				0,	0,	"Sub_Interval of timer"},
	{ V568_REGTYPE, "V5_REG_MARB_SUB_TIMER1",		V5_REG_MARB_SUB_TIMER1,				0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_TIMER_VAL0",		V5_REG_MARB_TIMER_VAL0,				0,	0,	"Value of timer"},
	{ V568_REGTYPE, "V5_REG_MARB_TIMER_VAL1",		V5_REG_MARB_TIMER_VAL1,				0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_TIMER_VAL2",		V5_REG_MARB_TIMER_VAL2,				0,	0,	""},
	{ V568_REGTYPE, "V5_REG_MARB_SUB_TIMER_VAL0",	V5_REG_MARB_SUB_TIMER_VAL0,			0,	0,	"Value of sub_timer"},
	{ V568_REGTYPE, "V5_REG_MARB_SUB_TIMER_VAL1",	V5_REG_MARB_SUB_TIMER_VAL1,			0,	0,	""}
};
...
static const TRegUnit gBiuReg[] =
{
	...
	{ V568_REGTYPE, "V5_REG_BIU_PLL_M", V5_REG_BIU_PLL_M, 0, 0, "Feedback 8-bit divider control pins" },
	{ V568_REGTYPE, "V5_REG_BIU_PLL_N", V5_REG_BIU_PLL_N	, 0, 0, "Input 4-bit divider control pins" },
	...
	{ V568_REGTYPE, "V5_REG_BIU_XCLK_DISABLE", V5_REG_BIU_XCLK_DISABLE, 0, 0, "[0] 1 - disable xclk, 0 - enable xclk\n" },
...
const int gV578ReglistCount = sizeof(gV578Reglist) / sizeof(TRegList);
