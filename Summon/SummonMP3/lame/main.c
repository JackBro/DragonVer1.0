...
/* $Id: main.c,v 1.1 2005/12/15 05:06:18 sx Exp $ */
...
//Mp3
const TMp3BitRate gMPEG1BitRate={{32,40,48,56,64,80,96,112,128,160,192,224,256,320},
{"32","40","48","56","64","80","96","112","128","160","192","224","256","320"}};
const TMp3BitRate gMPEG2BitRate={{8,16,24,32,40,48,56,64,80,96,112,128,144,160},
             ...
             char *outPath)
{
	...
	*(gfp->UserFrameTotalNum) = mp3input_data.totalframes;
    ...
    do {
		...
		*(gfp->UserframeNum)=mp3input_data.framenum;
             ...
             char *outPath)
{
    ...
    do {
		...
		*(gf->UserframeNum)=frames;
		*(gf->UserFrameTotalNum)=lame_get_totalframes(gf);
 /********************** status display  *****************************/
        if (silent <= 0) {
...
int
lame_entry(int argc, char **argv,int *fnum, int *ftotal)
{
    int     ret;
...
#define MAX_NOGAP 200
	...
	*/
	...
	//add User pointer
	gf->UserframeNum=fnum;
	gf->UserFrameTotalNum=ftotal;
    if (argc <= 1) {
