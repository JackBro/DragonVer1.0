...
/* $Id: parse.c,v 1.1 2005/12/15 05:06:18 sx Exp $ */
...
# endif
                        ...
                        case 'j': (void) lame_set_mode( gfp, JOINT_STEREO );
                       	...
                       	case 'm': 
								...
								case '\0':
									...
									break;
								case 'l':
									(void) lame_set_mode( gfp, MONOL         );
									break;
								case 'r':
									(void) lame_set_mode( gfp, MONOR         );
									break;
								}
                                  break;
	...
	else if( MONOL == lame_get_mode( gfp )  ) 
        (void) lame_set_num_channels( gfp, 2 );
	else if( MONOR == lame_get_mode( gfp )  ) 
        (void) lame_set_num_channels( gfp, 2);
    else 
        (void) lame_set_num_channels( gfp, 2 );
