#ifndef _CMODEL_YUVDIV_ALG_H_
#define _CMODEL_YUVDIV_ALG_H_
...
class CMODELSTALG_DLL CYuvdivAlg : public CImageAlgBase
{
public:
	CYuvdivAlg(void);
	virtual ~CYuvdivAlg(void);
