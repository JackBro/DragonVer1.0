...
const char *yaffs_guts_c_version="$Id: yaffs_guts.c,v 1.1 2005/12/15 05:06:46 sx Exp $";
...
int yaffs_GutsInitialise(yaffs_Device *dev)
{
	...
	dev->unlinkedDir = yaffs_CreateFakeDirectory(dev,YAFFS_OBJECTID_UNLINKED, 0040000);//S_IFDIR

	dev->rootDir = yaffs_CreateFakeDirectory(dev,YAFFS_OBJECTID_ROOT,YAFFS_ROOT_MODE | 0040000);
	dev->lostNFoundDir = yaffs_CreateFakeDirectory(dev,YAFFS_OBJECTID_LOSTNFOUND,YAFFS_LOSTNFOUND_MODE | 0040000);
