...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_DispatchPnP process\n"));
    ...
    MobiUsb_DbgPrint(2, (PnPMinorFunctionString(irpStack->MinorFunction)));
    ...
    case IRP_MN_STOP_DEVICE:
        ...
        MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_DispatchPnP::IRP_MN_STOP_DEVICE::\n"));
    ...
    case IRP_MN_SURPRISE_REMOVAL:
        ...
        MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_DispatchPnP::IRP_MN_SURPRISE_REMOVAL::\n"));
        MobiUsb_IoDecrement(deviceExtension);
    ...
    default:
        ...
        MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_DispatchPnP::default::\n"));
        MobiUsb_IoDecrement(deviceExtension);
...
// decrement count
//
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_DispatchPnP ends\n"));
    MobiUsb_IoDecrement(deviceExtension);
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleStartDevice - begins\n"));
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: Lower drivers failed this Irp\n"));
        return ntStatus;
    }
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: ReadandSelectDescriptors failed\n"));
        return ntStatus;
    }
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: IoSetDeviceInterfaceState:enable:failed\n"));
        return ntStatus;
    }
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleStartDevice - ends\n"));
...
--*/
{
    ...
    if(urb) {
        ...
        if(deviceDescriptor) {
            ...
            MobiUsb_DbgPrint(1, ("file mobipnp: Failed to allocate memory for deviceDescriptor\n"));
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: Failed to allocate memory for urb\n"));
    ...
    if(urb) {
        ...
        if(configurationDescriptor) {
            ...
            if(!NT_SUCCESS(ntStatus)) {
                ...
                MobiUsb_DbgPrint(1, ("file mobipnp: UsbBuildGetDescriptorRequest failed\n"));
                goto ConfigureDevice_Exit;
            }
        }
        else {

            MobiUsb_DbgPrint(1, ("file mobipnp: Failed to allocate mem for config Descriptor\n"));
        ...
        if(configurationDescriptor) {
            ...
            if(!NT_SUCCESS(ntStatus)) {
                ...
                MobiUsb_DbgPrint(1,("file mobipnp: Failed to read configuration descriptor\n"));
                goto ConfigureDevice_Exit;
            }
        }
        else {

            MobiUsb_DbgPrint(1, ("file mobipnp: Failed to alloc mem for config Descriptor\n"));
            ntStatus = STATUS_INSUFFICIENT_RESOURCES;
            goto ConfigureDevice_Exit;
        }
    }
...
--*/
{
    ...
    if(!tmp) {
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: Failed to allocate mem for interfaceList\n"));
    ...
    if(urb) {
        ...
        if(NT_SUCCESS(ntStatus)) {
            ...
            if(deviceExtension->UsbInterface) {
                ...
                ntStatus = STATUS_INSUFFICIENT_RESOURCES;
                MobiUsb_DbgPrint(1, ("file mobipnp: memory alloc for UsbInterface failed\n"));
            }
            ...
            MobiUsb_DbgPrint(3, ("file mobipnp: ---------\n"));
            MobiUsb_DbgPrint(3, ("file mobipnp: NumberOfPipes 0x%x\n", 
                                 Interface->NumberOfPipes));
            MobiUsb_DbgPrint(3, ("file mobipnp: Length 0x%x\n", 
                                 Interface->Length));
            MobiUsb_DbgPrint(3, ("file mobipnp: Alt Setting 0x%x\n", 
                                 Interface->AlternateSetting));
            MobiUsb_DbgPrint(3, ("file mobipnp: Interface Number 0x%x\n", 
                                 Interface->InterfaceNumber));
            MobiUsb_DbgPrint(3, ("file mobipnp: Class, subclass, protocol 0x%x 0x%x 0x%x\n",
                                 Interface->Class,
                                 Interface->SubClass,
                                 Interface->Protocol));
            //
            ...
            if(Interface->NumberOfPipes) {
                ...
                if(deviceExtension->PipeContext) {
                    ...
                    ntStatus = STATUS_INSUFFICIENT_RESOURCES;
                    MobiUsb_DbgPrint(1, ("memory alloc for UsbInterface failed\n"));
                }
            }
            ...
            for(i=0; i<Interface->NumberOfPipes; i++) {
                ...
                MobiUsb_DbgPrint(3, ("file mobipnp: ---------\n"));
                MobiUsb_DbgPrint(3, ("file mobipnp: PipeType 0x%x\n", 
                                     Interface->Pipes[i].PipeType));
                MobiUsb_DbgPrint(3, ("file mobipnp: EndpointAddress 0x%x\n", 
                                     Interface->Pipes[i].EndpointAddress));
                MobiUsb_DbgPrint(3, ("file mobipnp: MaxPacketSize 0x%x\n", 
                                    Interface->Pipes[i].MaximumPacketSize));
                MobiUsb_DbgPrint(3, ("file mobipnp: Interval 0x%x\n", 
                                     Interface->Pipes[i].Interval));
                MobiUsb_DbgPrint(3, ("file mobipnp: Handle 0x%x\n", 
                                     Interface->Pipes[i].PipeHandle));
                MobiUsb_DbgPrint(3, ("file mobipnp: MaximumTransferSize 0x%x\n", 
                                    Interface->Pipes[i].MaximumTransferSize));
            }
            ...
            MobiUsb_DbgPrint(1, ("file mobipnp: Failed to select an interface\n"));
        }
    }
    else {
        
        MobiUsb_DbgPrint(1, ("file mobipnp: USBD_CreateConfigurationRequestEx failed\n"));
        ntStatus = STATUS_INSUFFICIENT_RESOURCES;
    }
...
--*/
{
    ...
    if(urb) {
        ...
        if(!NT_SUCCESS(ntStatus)) {
            ...
            MobiUsb_DbgPrint(3, ("file mobipnp: file mobipnp: Failed to deconfigure device\n"));
        }
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: Failed to allocate urb\n"));
        ntStatus = STATUS_INSUFFICIENT_RESOURCES;
    }
...
--*/
{
    ...
    if(!irp) {
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: IoBuildDeviceIoControlRequest failed\n"));
        return STATUS_INSUFFICIENT_RESOURCES;
    }
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: CallUSBD::"));
    MobiUsb_IoIncrement(deviceExtension);
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryStopDevice - begins\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryStopDevice::"));
    MobiUsb_IoDecrement(deviceExtension);
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryStopDevice - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleCancelStopDevice - begins\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleCancelStopDevice - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleStopDevice - begins\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleStopDevice - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryRemoveDevice - begins\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryRemoveDevice::"));
    MobiUsb_IoDecrement(deviceExtension);
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryRemoveDevice - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleCancelRemoveDevice - begins\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleCancelRemoveDevice - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleSurpriseRemoval - begins\n"));
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: IoSetDeviceInterfaceState::disable:failed\n"));
    }

    RtlFreeUnicodeString(&deviceExtension->InterfaceName);

    MobiUsb_AbortPipes(DeviceObject);
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleSurpriseRemoval - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleRemoveDevice - begins\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleRemoveDevice::"));
    requestCount = MobiUsb_IoDecrement(deviceExtension);
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleRemoveDevice - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryCapabilities - begins\n"));
    ...
    if(pdc->Version < 1 || pdc->Size < sizeof(DEVICE_CAPABILITIES)) {
        ...
        MobiUsb_DbgPrint(1, ("file mobipnp: HandleQueryCapabilities::request failed\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: HandleQueryCapabilities - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: DpcRoutine - begins\n"));
    ...
    if(CanDeviceSuspend(deviceExtension)) {
        ...
        MobiUsb_DbgPrint(3, ("file mobipnp: Device is Idle\n"));
        ...
        if(item) {
            ...
            MobiUsb_DbgPrint(3, ("file mobipnp: Cannot alloc memory for work item\n"));
        ...
        MobiUsb_DbgPrint(3, ("file mobipnp: Idle event not signaled\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: DpcRoutine - ends\n"));
}    
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: IdleRequestWorkerRoutine - begins\n"));
    ...
    if(CanDeviceSuspend(deviceExtension)) {
        ...
        if(!NT_SUCCESS(ntStatus)) {
            ...
            MobiUsb_DbgPrint(1, ("file mobipnp: SubmitIdleRequestIrp failed\n"));
        }
    }
    else {

        MobiUsb_DbgPrint(3, ("file mobipnp: Device is not idle\n"));
    }
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: IdleRequestsWorkerRoutine - ends\n"));
}
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: ProcessQueuedRequests - begins\n"));
    ...
    while(1) {
        ...
        if(nextIrp->Cancel) {
            ...
            if(FailRequests == DeviceExtension->QueueState) {
                ...
                MobiUsb_DbgPrint(3, ("file mobipnp: ProcessQueuedRequests::"));
                MobiUsb_IoIncrement(DeviceExtension);
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: ProcessQueuedRequests - ends\n"));

    return;
}

NTSTATUS
MobiUsb_GetRegistryDword(
    IN     PWCHAR RegPath,
    IN     PWCHAR ValueName,
    IN OUT PULONG Value
    )
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_GetRegistryDword - process\n"));
    ...
    if(NT_SUCCESS(ntStatus)) {
        ...
        MobiUsb_DbgPrint(3, ("file mobipnp: success Value = %X\n", *Value));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_DispatchClean::\n"));
    MobiUsb_IoIncrement(deviceExtension);
...
--*/
{
    MobiUsb_DbgPrint(3, ("file mobipnp: CanDeviceSuspend\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_AbortPipes - begins\n"));
    ...
    for(i=0; i<interfaceInfo->NumberOfPipes; i++) {
        ...
        if(pipeContext[i].PipeOpen) {
            ...
            MobiUsb_DbgPrint(3, ("file mobipnp: Aborting open pipe %d\n", i));
            ...
            if(urb) {
                ...
                MobiUsb_DbgPrint(1, ("file mobipnp: Failed to alloc memory for urb\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_AbortPipes - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_IoIncrement::%d\n", result));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobipnp: MobiUsb_IoDecrement::%d\n", result));
...
--*/
{
    switch (MinorFunction) {
        ...
        case IRP_MN_START_DEVICE:
            return "file mobipnp: IRP_MN_START_DEVICE\n";

        case IRP_MN_QUERY_REMOVE_DEVICE:
            return "file mobipnp: IRP_MN_QUERY_REMOVE_DEVICE\n";

        case IRP_MN_REMOVE_DEVICE:
            return "file mobipnp: IRP_MN_REMOVE_DEVICE\n";

        case IRP_MN_CANCEL_REMOVE_DEVICE:
            return "file mobipnp: IRP_MN_CANCEL_REMOVE_DEVICE\n";

        case IRP_MN_STOP_DEVICE:
            return "file mobipnp: IRP_MN_STOP_DEVICE\n";

        case IRP_MN_QUERY_STOP_DEVICE:
            return "file mobipnp: IRP_MN_QUERY_STOP_DEVICE\n";

        case IRP_MN_CANCEL_STOP_DEVICE:
            return "file mobipnp: IRP_MN_CANCEL_STOP_DEVICE\n";

        case IRP_MN_QUERY_DEVICE_RELATIONS:
            return "file mobipnp: IRP_MN_QUERY_DEVICE_RELATIONS\n";

        case IRP_MN_QUERY_INTERFACE:
            return "file mobipnp: IRP_MN_QUERY_INTERFACE\n";

        case IRP_MN_QUERY_CAPABILITIES:
            return "file mobipnp: IRP_MN_QUERY_CAPABILITIES\n";

        case IRP_MN_QUERY_RESOURCES:
            return "file mobipnp: IRP_MN_QUERY_RESOURCES\n";

        case IRP_MN_QUERY_RESOURCE_REQUIREMENTS:
            return "file mobipnp: IRP_MN_QUERY_RESOURCE_REQUIREMENTS\n";

        case IRP_MN_QUERY_DEVICE_TEXT:
            return "file mobipnp: IRP_MN_QUERY_DEVICE_TEXT\n";

        case IRP_MN_FILTER_RESOURCE_REQUIREMENTS:
            return "file mobipnp: IRP_MN_FILTER_RESOURCE_REQUIREMENTS\n";

        case IRP_MN_READ_CONFIG:
            return "file mobipnp: IRP_MN_READ_CONFIG\n";

        case IRP_MN_WRITE_CONFIG:
            return "file mobipnp: IRP_MN_WRITE_CONFIG\n";

        case IRP_MN_EJECT:
            return "file mobipnp: IRP_MN_EJECT\n";

        case IRP_MN_SET_LOCK:
            return "file mobipnp: IRP_MN_SET_LOCK\n";

        case IRP_MN_QUERY_ID:
            return "file mobipnp: IRP_MN_QUERY_ID\n";

        case IRP_MN_QUERY_PNP_DEVICE_STATE:
            return "file mobipnp: IRP_MN_QUERY_PNP_DEVICE_STATE\n";

        case IRP_MN_QUERY_BUS_INFORMATION:
            return "file mobipnp: IRP_MN_QUERY_BUS_INFORMATION\n";

        case IRP_MN_DEVICE_USAGE_NOTIFICATION:
            return "file mobipnp: IRP_MN_DEVICE_USAGE_NOTIFICATION\n";

        case IRP_MN_SURPRISE_REMOVAL:
            return "file mobipnp: IRP_MN_SURPRISE_REMOVAL\n";

        default:
            return "file mobipnp: IRP_MN_???\n";
    }
}
