...
#define WMI_MOBIUSB_DRIVER_INFORMATION 0

DEFINE_GUID (MOBIUSB_WMI_STD_DATA_GUID, 
0xBBA21300, 0x6DD3, 0x11d2, 0xB8, 0x44, 0x00, 0xC0, 0x4F, 0xAD, 0x51, 0x71);

WMIGUIDREGINFO MobiWmiGuidList[1] = { {

        &MOBIUSB_WMI_STD_DATA_GUID, 1, 0 // driver information
    }
};
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, (WMIMinorFunctionString(irpStack->MinorFunction)));
	...
	MobiUsb_DbgPrint(3, ("file mobiwmi: MobiUsb_DispatchSysCtrl::\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobiwmi: MobiUsb_QueryWmiRegInfo - begins\n"));
    ...
    *Pdo          = deviceExtension->PhysicalDeviceObject;
    ...
    MobiUsb_DbgPrint(3, ("file mobiwmi: MobiUsb_QueryWmiRegInfo - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobiwmi: MobiUsb_QueryWmiDataBlock - begins\n"));
    ...
    case WMI_MOBIUSB_DRIVER_INFORMATION:
        ...
        if (OutBufferSize < size ) {
            ...
            MobiUsb_DbgPrint(3, ("file mobiwmi: OutBuffer too small\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobiwmi: MobiUsb_QueryWmiDataBlock - ends\n"));
...
--*/
{
    ...
    MobiUsb_DbgPrint(3, ("file mobiwmi: MobiUsb_SetWmiDataBlock - begins\n"));
    ...
    MobiUsb_DbgPrint(3, ("file mobiwmi: MobiUsb_SetWmiDataBlock - ends\n"));
...
--*/
{
    switch (MinorFunction) {
        ...
        case IRP_MN_CHANGE_SINGLE_INSTANCE:
            return "file mobiwmi: IRP_MN_CHANGE_SINGLE_INSTANCE\n";

        case IRP_MN_CHANGE_SINGLE_ITEM:
            return "file mobiwmi: IRP_MN_CHANGE_SINGLE_ITEM\n";

        case IRP_MN_DISABLE_COLLECTION:
            return "file mobiwmi: IRP_MN_DISABLE_COLLECTION\n";

        case IRP_MN_DISABLE_EVENTS:
            return "file mobiwmi: IRP_MN_DISABLE_EVENTS\n";

        case IRP_MN_ENABLE_COLLECTION:
            return "file mobiwmi: IRP_MN_ENABLE_COLLECTION\n";

        case IRP_MN_ENABLE_EVENTS:
            return "file mobiwmi: IRP_MN_ENABLE_EVENTS\n";

        case IRP_MN_EXECUTE_METHOD:
            return "file mobiwmi: IRP_MN_EXECUTE_METHOD\n";

        case IRP_MN_QUERY_ALL_DATA:
            return "file mobiwmi: IRP_MN_QUERY_ALL_DATA\n";

        case IRP_MN_QUERY_SINGLE_INSTANCE:
            return "file mobiwmi: IRP_MN_QUERY_SINGLE_INSTANCE\n";

        case IRP_MN_REGINFO:
            return "file mobiwmi: IRP_MN_REGINFO\n";

        default:
            return "file mobiwmi: IRP_MN_?????\n";
    }
}
