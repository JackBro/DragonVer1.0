...
;bank7	16bit SDRAM
    [ BUSWIDTH=16
	   DCD 0x11100101	;Bank0=16bit BootRom(AT29C010A*2) :0x0  //datawidth=8
    | ;BUSWIDTH=32
	DCD 0x22202220	;Bank0=OM[1:0], Bank1~Bank7=32bit   ;Bank4 bus width 8
    ]
	;DCD 0x11100102	;Bank0=OM[1:0], Bank1~Bank7=32bit   ;Bank4 bus width 8
