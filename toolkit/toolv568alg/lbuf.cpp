...
int CYuvBlkBufBase::CalYuvSize(char fmt, int width, int line)
{
	int size = 0;
...
int CYuvBlkBufBase::CalAllocMemSize(char fmt, int width)
{
	switch(fmt)
	{
	case YUV422BLK:
